        ...
        <div className='flex flex-col lg:flex-row py-10 mb-8 space-x-6 px-4'>
            <div className='mb-12 px-2'>
              ...
              <div className='text-white'>
                <h2 className='mt-6 font-semibold'>Subscribe to our developer newsletter</h2>
                <p className="text-[14px] text-[#7d8590] mb-6 ">Get tips, technical guides, and best practices. Twice a month. Right in your inbox.</p>
      ...
      <div className='bg-[#161b22]'>
        <div className='max-w-[1280px] mx-auto text-[12px] md:flex flex-row-reverse py-6 justify-between items-center px-4'>
          ...
          <ul className='flex items-center mb-4 sm:mb-0 text-[#7d8590] flex-wrap' >
            ...
            <li className='mr-3 '><a href="">Manage cookies</a></li>
            <li className='mr-3 '><a href="">Do not share my personal information</a></li>
          </ul>
        </div>
      </div>
      </div>
